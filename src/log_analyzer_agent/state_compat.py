...
from .state import (
    ...
    create_state_class, get_state_features
)
...
class StateAdapter:
    ...
    @staticmethod
    def create_minimal_state(log_content: str, environment_details: Optional[Dict[str, Any]] = None) -> CoreState:
    ...
    @staticmethod
    def upgrade_state(state: CoreState, features: Set[str]) -> Union[CoreState, InteractiveState, MemoryState]:
