...
from .models import (
    ...
    LogAnalysisRequest, LogAnalysisResponse, AnalysisResult, AnalysisIssue,
    UserPreferences, MemorySearchRequest, MemorySearchResponse,
    AnalysisHistoryResponse, ApplicationContext, ErrorResponse
)
...
@router.get("/applications/{application_name}/context", response_model=ApplicationContext)
...
@router.post("/applications/{application_name}/context", response_model=ApplicationContext)
