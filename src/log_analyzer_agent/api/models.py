...
class LogAnalysisRequest(BaseModel):
    ...
    application_version: Optional[str] = Field(None, description="Version of the application")
    environment_type: Optional[str] = Field(None, description="Environment type (dev, staging, prod)")
    environment_details: Optional[Dict[str, Any]] = Field(None, description="Additional environment details")
...
class UserPreferences(BaseModel):
    ...
    analysis_style: str = Field("comprehensive", description="Analysis style preference")
    output_format: str = Field("detailed", description="Output format preference")
    include_diagnostic_commands: bool = Field(True, description="Include diagnostic commands")
...
class MemorySearchRequest(BaseModel):
    ...
    context_type: str = Field("analysis_history", description="Type of memory context to search")
